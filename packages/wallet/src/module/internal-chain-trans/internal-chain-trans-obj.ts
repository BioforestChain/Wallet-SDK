...
import type { InternalChainTransMgr } from "./internal-chain-trans-mgr.js";
...
import type { InternalChainName, InternalTransStateID} from "@bnqkl/wallet-sdk";
import { TRANS_TEMP_QUEUE_ROUTING_KEY } from "@bnqkl/wallet-sdk";
