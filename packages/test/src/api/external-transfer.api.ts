...
export class ExternalTransferApi {
     ...
     * @param account
     */
    static parseEthAccount(account: WalletTest.ExternalTransferArgs["account"]) {
     ...
     * @returns
     */
    static async ethTransfer(arg: WalletTest.ExternalTransferArgs, network: NetWorkHelper, ethTransPrepResDto?: WalletTypings.Eth.Api.EthTransPrepResDto) {
     ...
     * @returns
     */
    static async ethMultiTransfer(arg: WalletTest.ExternalTransferArgs, transferNum: number, network: NetWorkHelper) {
        const { account, to, contractAddress, amount } = arg;
     ...
     * @param arg
     * @param network
     * @param MetaBoxServer.ExternalChain.EthTransPrepReq
     * @returns
     */
    static async bscTransfer(arg: WalletTest.ExternalTransferArgs, network: NetWorkHelper, bscTransPrepResDto?: WalletTypings.Eth.Api.EthTransPrepResDto) {
        const { account, to, contractAddress, amount } = arg;
        const { privateKey, from } = this.parseEthAccount(account);
     ...
     * @returns
     */
    static async bscMultiTransfer(arg: WalletTest.ExternalTransferArgs, transferNum: number, network: NetWorkHelper) {
        const { account, to, contractAddress, amount } = arg;
        const { from } = this.parseEthAccount(account);
     ...
     * @returns
     */
    static async trc20Transfer(arg: WalletTest.ExternalTransferArgs, network: NetWorkHelper) {
     ...
     * @returns
     */
    static async trc20MultiTransfer(arg: WalletTest.ExternalTransferArgs, transferNum: number, network: NetWorkHelper) {
        const params: number[] = [];
        for (let i = 0; i < transferNum; i++) {
            params.push(i);
        }
